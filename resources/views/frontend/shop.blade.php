...
@section('title', 'Shop') <!-- Set the title for the page -->
                        ...
                        <ul class="shop-modern shop-wrapper grid-loading grid grid-4col xl-grid-3col sm-grid-2col xs-grid-1col gutter-extra-large text-center" data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                                ...
                                <div class="shop-box mb-10px">
                                    <div class="shop-image mb-20px">
                                        ...
                                        <div class="shop-buttons-wrap">
                                            <a href="{{route ('single-product')}}" class="alt-font btn btn-small btn-box-shadow btn-white btn-round-edge left-icon add-to-cart">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Textured sweater</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Traveller shirt</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Crewneck sweatshirt</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Skinny trousers</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Sleeve sweater</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Pocket sweatshirt</a>
                                        <div class="price lh-22 fs-16"><del>$200.00</del>$189.00</div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Cotton sweater</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Texture regular</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Sequined dress</a>
                            ...
                            <li class="grid-item">
                                <div class="shop-box mb-10px">
                                    ...
                                    <div class="shop-footer text-center">
                                        <a href="{{route ('single-product')}}" class="alt-font text-dark-gray fs-19 fw-500">Bermuda shorts</a>
                                        ...
                                        <div class="shop-filter new-arribals"> 
                                            <div class="d-flex align-items-center mb-20px">
                                                ...
                                                <div class="col ps-25px">
                                                    <a href="{{route ('single-product')}}" class="text-dark-gray alt-font fw-500 d-inline-block lh-normal">Textured sweater</a>
                                            ...
                                            <div class="d-flex align-items-center mb-20px">
                                                ...
                                                <div class="col ps-25px">
                                                    <a href="{{route ('single-product')}}" class="text-dark-gray alt-font fw-500 d-inline-block lh-normal">Traveller shirt</a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="col ps-25px">
                                                    <a href="{{route ('single-product')}}" class="text-dark-gray alt-font fw-500 d-inline-block lh-normal">Crewneck tshirt</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="shop-filter new-arribals"> 
                                            <div class="d-flex align-items-center mb-20px">
                                                ...
                                                <div class="col ps-25px">
                                                    <a href="{{route ('single-product')}}" class="text-dark-gray alt-font fw-500 d-inline-block lh-normal">Skinny trousers</a>
                                            ...
                                            <div class="d-flex align-items-center mb-20px">
                                                ...
                                                <div class="col ps-25px">
                                                    <a href="{{route ('single-product')}}" class="text-dark-gray alt-font fw-500 d-inline-block lh-normal">Sleeve sweater</a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="col ps-25px">
                                                    <a href="{{route ('single-product')}}" class="text-dark-gray alt-font fw-500 d-inline-block lh-normal">Pocket white</a>
                                                    <div class="fs-15 lh-normal"><del class="me-5px">$20.00</del>$15.00</div>
                                                </div>
                                            </div>
                                        </div>
