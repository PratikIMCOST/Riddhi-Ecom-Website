                    ...
                    <div class="col-auto col-xxl-6 col-lg-8 menu-order">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarNav"> 
                                        ...
                                        <div class="d-lg-flex mega-menu m-auto flex-column"> 
                                            <div class="row row-cols-2 row-cols-lg-6 row-cols-md-3 row-cols-sm-2 md-mx-0 align-items-center justify-content-center">
                                                <div class="col md-mb-25px">
                                                    <a href="{{ route('collection') }}" class="justify-content-center mb-10px"> 
                                                        <img src="https://via.placeholder.com/190x140" class="border-radius-4px w-100" alt="">  
                                                    </a>
                                                    <a href="{{ route('collection') }}" class="btn btn-hover-animation fw-500 text-uppercase-inherit justify-content-center pt-0 pb-0">
                                                        <span> 
                            ...
                            <ul class="navbar-nav alt-font navbar-right justify-content-start"> 
                                <li class="nav-item">
                                    <a href="{{ route('magazine') }}" class="nav-link">Magazine</a>
                                </li>
