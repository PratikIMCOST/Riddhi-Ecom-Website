    ...
    <div class="container">
        <div class="row align-items-center pt-35px pb-35px">
            <div class="col-12 col-md-auto sm-mb-15px text-center text-md-start"> 
                <a href="{{ url('/') }}" class="footer-logo"><img src="{{ asset('images/demo-fashion-store-logo-white.png') }}" alt="" class="default-logo"></a>
            </div>
            <div class="col"> 
                <ul class="footer-navbar text-center text-md-end"> 
                    ...
                    <li class="nav ```blade
                    <li class="nav-item"><a href="{{ route('collection') }}" class="nav-link">Collection</a></li>
                    <li class="nav-item"><a href="{{ route('magazine') }}" class="nav-link">Magazine</a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-7 ps-20px sm-ps-15px md-mb-50px xs-mb-0 order-sm-1 order-lg-5">
                ...
                <div class="d-inline-block w-100 newsletter-style-04 position-relative mb-15px"> 
                    <form action="email-templates/subscribe-newsletter.php" method="post" class="position-relative w-100">
                        <input class="input-small bg-nero-grey border-radius-4px fs-14 border-color-transparent w-100 form-control pe-50px ps-20px lg-ps-15px required" type="email" name="email" placeholder="Enter your email" />
                        <input type="hidden" name="redirect" value="">
                        <button class="btn pe-20px submit" aria-label="submit"><i class="icon bi bi-envelope icon-small text-white"></i></button>
                        <div class="form-results border-radius-4px pt-5px pb-5px fs-14 lh-22 mt-10px w-100 text-center position-absolute d-none"></div>
                    </form>
                </div>
